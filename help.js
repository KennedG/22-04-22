...
<:download:910474079931338813> No total de **149** Comandos.
...
'`Ship|Cafune|Beijar|Casar|Abraço|Atacar|Futebol|Jokempo|Dados|Brindar|Stonks|8ball|Coinflip|emojiinfo|Adestramento|Faustão|Cantadas|Traficaranao|Bolsonaro|Corno|Gay|Audio|Falar`', true) 
...
msg.edit({embeds: [embed_1]})
	...
	.addField('⚒️ Comandos Moderação:',  
            '`Ban | Unban | Unbanall | Voicekick | Antilink | Lock | Unlock | Setnick | Addcargo | Removecargo | Lockall | Unlockall | Roleinfo | Contador |`', true) 
